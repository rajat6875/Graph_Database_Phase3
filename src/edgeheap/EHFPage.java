...
import global.*;
import edgeheap.InvalidSlotNumberException;
import heap.Tuple;
import diskmgr.*;
...
public class EHFPage extends Page 
  ...
  */
   ...
   * @exception  IOException I/O errors
   * in C++ Status firstEdge(EID& firstEid)
   * 
   */ 
   ...
   * @exception  IOException I/O errors
   * in C++ Status nextEdge (EID curEid, EID& nextEid)
   */
   ...
   * @see 	Tuple
   */  
  public Tuple returnEdge ( EID eid )
    throws IOException, 
	   InvalidSlotNumberException
    {
      short recLen;
   ...
   * WARNING -- this will probably lead to a change in the EIDs of
