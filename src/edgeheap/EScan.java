...
import edgeheap.EHFBufMgrException;
...
public class EScan implements GlobalConst{
   ...
   * @exception IOException I/O errors
   *
   * @param eid Edge ID of the record
	   ...
	   IOException
  {
    ...
    try {
      recptrtuple = datapage.getRecord(eid);
    }
  ...
  //    System.err.println("SCAN: Error in EScan" + e);
     ...
     * @exception InvalidTupleSizeException Invalid tuple size
     * @exception IOException I/O errors
     * @param eid Edge ID of the given record
	   ...
	   IOException
  {
	...
	//    System.err.println("SCAN: Error getEdge 4: " + e);
	    e.printStackTrace();
	  }
	...
	//  System.err.println("SCAN Error: 1st_next 0: " + e);
       ...
       *    - this->datapage == NULL, this->datapageId, this->datapageEid valid
  ...
  //    - this->datapageEid valid
  //    - current data page unpinned !!!
  // (3) if somewhere in heapfile
  //    - this->datapageId, this->datapage, this->datapageEid valid
  ...
  // ASSERTIONS:
  // - this->datapage, this->datapageId, this->datapageEid valid
  // - current datapage pinned
    ...
    // - this->datapageEid has the Eid of the next datapage to be read
	...
	datapageId.pid = dpinfo.pageId.pid;
     ...
     // - this->datapageId, this->datapage, this->datapageEid correct
  ...
  private void pinPage(PageId pageno, Page page, boolean emptyPage)
    ...
    try {
      ...
      throw new EHFBufMgrException(e,"EScan.java: pinPage() failed");
    }
  ...
  private void unpinPage(PageId pageno, boolean dirty)
    ...
    try {
      ...
      throw new EHFBufMgrException(e,"EScan.java: unpinPage() failed");
    }
